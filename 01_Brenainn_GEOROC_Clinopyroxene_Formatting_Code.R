...
#---- Import data ----
GEOROC_Clinopyroxene <- read_csv("2023-06-SGFTFN_CLINOPYROXENES_Brenainn.csv") ## You need to set this to the appropriate file name
...
#---- Order filtered data set to same as Teresa's stoichiometry spreadsheet ----
